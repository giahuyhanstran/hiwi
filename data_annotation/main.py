...
class App:
    ...
    def __init__(self):
        ...
        def start_recording(type: str):
            ...
            script_path = os.path.join(self.__main_dir, get_script(type=type))
        ...
        def render_file_selection():
            ...
            browse_button = tk.Button(self.__sensor_selection_frame, text="Browse", command=browse_cfg_file, fg='white', bg='gray20')
            browse_button.pack(pady=5)

            rgb_browse_button = tk.Button(self.__video_selection_frame, text="Browse", command=browse_rgb_cfg_file, fg='white', bg='gray20')
        ...
        def render_ip_view():
            ...
            if verify_cfg(self.__cfg_file_entry.get(), type='sensor') or verify_cfg(self.__rgb_cfg_file_entry.get(), type='camera'):
                ...
                if verify_cfg(self.__cfg_file_entry.get(), type='sensor'):

                    ip_address, port = get_ip_port(self.__cfg_file_entry.get())
                ...
                select_button = tk.Button(self.__ip_container_frame, text="Select Save Location", command=browse_save_location, fg='white', bg='gray20')
